...
public final class DeviceIdentity {
    private static final String DEVICE_DOMAIN = "SEMBULUNG_NAVIGATOR_DEVICE_V1";
    ...
    public static String rawAndroidId(Context context) {
        ...
        return id == null ? "UNKNOWN_ANDROID_ID" : id;
    }

    public static String deviceCode(Context context) {
        try {
            String material = DEVICE_DOMAIN + "|" + context.getPackageName() + "|" + rawAndroidId(context);
    ...
    public static String formattedDeviceCode(Context context) {
        ...
        return "SNV-" + c.substring(0, 4) + "-" + c.substring(4, 8) + "-" +
                c.substring(8, 12) + "-" + c.substring(12, 16) + "-" + c.substring(16, 20);
    }
}
